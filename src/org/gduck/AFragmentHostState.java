...
/**
 * Extends AFsmState to represent the use of a shared ViewGroup host for one of
...
public abstract class AFragmentHostState<E extends Enum<E>>
	...
	private AFragmentHostManager<E> mHostManager = null;
	...
	private void setHostManager(IControl parent) {
		...
		AFragmentHostManager<E> manager = 		// as does this assignment
			(AFragmentHostManager<E>) parent; 	// but cast should be safe
