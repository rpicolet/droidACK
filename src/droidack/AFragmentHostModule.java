...
/**
 * Extends AViewStateModule to enable supervising 
...
public abstract class AFragmentHostModule<E extends Enum<E>> 
			  extends AViewStateModule<E> {
	 ...
	 */
	@Override
	protected final void onStart(IViewState<E> state) {
	 ...
	 */
	@Override
	protected final void transition(IViewState<E> oldState,
